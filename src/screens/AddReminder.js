    ...
    return (
      <>
        <View
          ...
          <Text
            style={{fontSize: 27, fontWeight: 'bold', bottom: 84, left: 61}}>
            {this.state.setSelectedDate
              ? this.state.setSelectedDate.toLocaleDateString()
              : ' '}
          </Text>
          <Text
            style={{fontSize: 27, fontWeight: 'bold', bottom: 38, left: 52}}>
          ...
          <TouchableOpacity
            ...
            <Text style={{color: '#1473D9', fontSize: 27}}>
              {' '}
              Selected Date:{' '}
            </Text>
          </TouchableOpacity>
